...
@Component({
  ...
  styleUrls: ['./p-multiselect.component.scss'],
  encapsulation: ViewEncapsulation.Emulated,
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => TenjinMultiSelectComponent),
      multi: true
    },
  ]
})
export class TenjinMultiSelectComponent extends TenjinComponent implements AfterViewInit {
